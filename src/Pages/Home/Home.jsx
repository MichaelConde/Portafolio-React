...
export const Home = () => {
  return (
    <>
      <div className="w-full h-screen flex justify-center items-center flex-col md:flex-row md:justify-between md:items-center px-4 md:px-10">
    
        <div className="w-full md:w-1/2 text-center md:text-left p-4">
          <h1 className="text-3xl md:text-5xl mb-6">Hola mi nombre es Michael</h1>
        ...
        <ImgComponent 
          component={img} 
          style="w-full md:w-1/2 h-auto p-4 md:p-10 ml-0 md:ml-10 mt-4 md:mt-0" 
        />
      </div>
    </>
  );
